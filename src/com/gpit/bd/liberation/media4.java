...
public class media4 extends Activity {
  
 //String SrcPath = "android.raw://com.gpit.bd.liberation.movievp8/sdcard/Video/Android in Spaaaaaace!_low.mp4";
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      // myVideoView.setVideoPath(SrcPath);
       Uri uri = Uri.parse("android.resource://" + getPackageName() + "/"+R.raw.nbc2);
